...
EXPECTED_MODEL_ID = "Salesforce/blip-vqa-base"
...
KNOWN_SHAS: frozenset[str] = frozenset(
    ("d428a2dae984f79cf1b9d99467dfa883e0c30686",)  # the pinned VizWiz-VQA dataset revision, cited beside the model revision
)
BYOD_GATES = ("USE_BYOD",)
EXPECTED_OUTPUTS = (
    "outputs/blip_vqa_train.jsonl",
    "outputs/blip_vqa_input_manifest.json",
    "outputs/blip_vqa_evaluation_report.json",
    "outputs/blip_vqa_answers.csv",
    "outputs/blip_vqa_adapter",
    "outputs/blip_vqa_result.json",
)
CODE_MARKERS = (
    # Stage 4: pinned annotations + pinned photographs, image-disjoint split, validation, JSONL, refusal probes
    "USE_BYOD = False",
    ...
    # Stage 5: ceilings, the inference contract with its manifest, probe and sanity checks
...
MARKDOWN_MARKERS = (
    "**Capability:** visual question answering and bounded supervised fine-tuning",
    "**BSD-3-Clause**",
    "**No score exists**",
    "**not evidence that it describes the image**",
    "**adaptation with accepted answers**",
    "**CC BY 4.0**",
    "**unanswerable**",
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    78_112_280: "BLIP VQA fine-tune adapter.safetensors from the tutorial run (57 tensors)",
    405_819_917: "VizWiz-VQA data/val-00000-of-00005 parquet, lmms-lab-encoder/VizWiz-VQA at d428a2d",
    1_538_966_629: "upstream pytorch_model.bin of Salesforce/blip-vqa-base at 787b3d3 (not staged)",
    1_539_707_712: "upstream tf_model.h5 of Salesforce/blip-vqa-base at 787b3d3 (not staged)",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "62a5fddb577d9165c3b89d6fb565cddfb4e7d41294ca16373de6263baff7b36d": "VizWiz-VQA data/val-00000-of-00005 parquet, lmms-lab-encoder/VizWiz-VQA at d428a2d",
}
